...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void justOptionalAttendeesWithGapsInSchedule() {
    // Have two optional attendees, with gaps in their schedule
    // Return those gaps for the meeting
  ...
  public void justOptionalAttendeesWithNoGapsInSchedule() {
    // Have two optional attendees, without gaps in their schedule
    // Events  : |--A-----||------B----|
    // Day     : |---------------------|
    // Options :
